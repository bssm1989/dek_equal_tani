<?php 
    ...
    WHERE b.pertypid='1' AND b.pertypid <> '' and optid = $optid
    ORDER BY nme,surnme";
    //echo $sql;
...
<div class="row justify-content-between card-header text-right mb-0">
    <div class="col-auto">
        <h4 class="app-page-title mb-0"> ข้อมูลกลุ่มเปราะบาง :: ผู้สูงอายุ</h4>
    </div>
    <div class="col-auto">
                                ...
                                <tr>
                                    ...
                                    <td class="align-middle text-center">
                                        <div class="btn-group" role="group">
                                            <!-- <a href="?page=<?=$_GET['page']?>&function=show&id=<?=$rows['enroll_id']?>"
