<?php 
    ...
    b.roladr,b.rolvllno,plcnmegen,b.pertypid,pertypnme,lat,lon
    ...
    WHERE b.pertypid <> '' and optid = $optid
    ORDER BY nme,surnme";
    // echo $sql;
...
<div class="row justify-content-between card-header text-right mb-0">
    <div class="col-auto">
        <h4 class="app-page-title mb-0"> ข้อมูลกลุ่มเปราะบาง</h4>
    </div>
    <div class="col-auto">
                        ...
                        <table class="table" id="myTableAll">
                            <thead class="table-light">
                                <tr>
                                    ...
                                    <th class="align-middle text-start" scope='col'>ชื่อ-นามสกุล อายุ และที่อยู่ </th>
                                    ...
                                    <th class="align-middle text-center" scope='col'>ละติจูด</th>
                                    <th class="align-middle text-center" scope='col'>ลองจิจูด</th>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td class="align-middle text-start"><?php echo $nme." อายุ ".$age_now; ?><br><?php echo $plc2; ?></td>
                                    ...
                                    <td class="align-middle text-center"><?=$rows['lat']?></td>
                                    <td class="align-middle text-center"><?=$rows['lon']?></td>
