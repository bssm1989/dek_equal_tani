<?php 
    ...
    WHERE b.pertypid='6' AND b.pertypid <> '' and optid = $optid
    ORDER BY nme,surnme";
    //echo $sql;
...
<div class="row justify-content-between card-header text-right mb-0">
    <div class="col-auto">
        <h4 class="app-page-title mb-0"> ข้อมูลกลุ่มเปราะบาง :: หญิงหม้าย</h4>
    </div>
    <div class="col-auto">
            ...
            <div class="app-card-body">
                <form name="frmUserSearch" id="frmUserSearch" method="post" action="" enctype="" onSubmit="" target="">
                    <div class="table-responsive-sm">
                        <!-- <div class="row">
                            <div class="col-md-5">
                                <label for="enroll_year"> ปีการศึกษา : ห้องเรียน</label>
                                <div class="input-group mb-3">
                                    <select class="form-control" name="enroll_year" id="enroll_year" required>
                                        <option value="0000" selected>ระบุปีการศึกษา</option>
                                        <?php
                                        $year = date('Y')+543;
                                        for($i=2563;$i<=$year+2;$i++){
                                        ?>
                                        <option value="<?=$i;?>" <?php if($i==$enroll_year) echo "selected";?>><?=$i;?>
                                        </option>
                                        <?php
                                        } // for
                                        ?>
                                    ...
                                    <input type="text" id="room_id" name="room_id" class="form-control search-docs"
                                        placeholder="ห้องเรียน" value="<?=$room_id;?>">

                                    <button type="submit" class="btn app-btn-secondary"><i class="fas fa-search"></i>
                                        ค้นหา
                                    </button>
                                    <a href="?page=persons" type="button" class="btn app-btn-secondary">เคลีย์
                                    </a>
