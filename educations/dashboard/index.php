...
<div class="row g-4 mb-3">
    <div class="col-6 col-lg-3">
        <div class="app-card app-card-stat shadow-sm h-100">
            <div class="app-card-body p-3 p-lg-4">
                <h4 class="stats-type mb-1">ผู้สูงอายุ</h4>
    ...
    <div class="col-6 col-lg-3">
        <div class="app-card app-card-stat shadow-sm h-100">
            <div class="app-card-body p-3 p-lg-4">
                <h4 class="stats-type mb-1">คนพิการ</h4>
    ...
    <div class="col-6 col-lg-3">
        <div class="app-card app-card-stat shadow-sm h-100">
            <div class="app-card-body p-3 p-lg-4">
                <h4 class="stats-type mb-1">เด็กกำพร้า/เด็กด้อยโอกาส</h4>
                <div class="stats-figure"><?php echo $famale; ?></div>
    ...
    <div class="col-6 col-lg-3">
        <div class="app-card app-card-stat shadow-sm h-100">
            <div class="app-card-body p-3 p-lg-4">
                <h4 class="stats-type mb-1">หญิงหม้ายจากเหตุการณ์ฯ</h4>
                <div class="stats-figure"><?php echo $room; ?></div>
                <!-- <div class="stats-meta">ใหม่</div> -->
            </div>
            <!--//app-card-body-->
            <a class="app-card-link-mask" href="#"></a>
        </div>
