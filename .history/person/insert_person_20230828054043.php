...
//change to pdo
$dbh = new PDO('mysql:host=localhost;dbname=dek_equal_tani', 'root', 'root');
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($action === 'insert') {
        ...
        function insertData($table, $data, $conn)
        {
            ...
            try {
                ...
                if ($stmt->execute()) {
                    ...
                    $temp = $conn->fetch(PDO::FETCH_ASSOC);
                    print_r($temp);
        ...
        if ($personInsert !== false && $personInsert !== null) {
            ...
            //Type: input Name: name Value: bassam.u
            //Type: input Name: surname Value: e
            //Type: input Name: national_id Value: 22222222222
            //Type: select Name: gender_id Value: 2
            //Type: select Name: religion_id Value: 1
            //Type: input Name: religion_other Value: 
            //Type: input Name: birth_date Value: 
            //Type: input Name: age Value: 2
            //Type: input Name: postcode Value: 94000
            //Type: input Name: address Value: 52 m.3, T.talubo a.muang
            //Type: input Name: street Value: erererere
            //Type: input Name: place_id Value: 10040300
            //Type: select Name: undefined Value: 10
            //Type: select Name: undefined Value: 04
            //Type: select Name: undefined Value: 03
            //Type: input Name: phone_number Value: 2
            //Type: input Name: child_order Value: 2
            //Type: select Name: livew_id Value: 3
            //Type: select Name: family_status Value: 5
            //Type: input Name: distance_to_school_km Value: 2
            //Type: input Name: travel_time_to_school Value: 2
            //Type: input Name: fare_per_month Value: 2
            //Type: select Name: main_transportation_id Value: 4
            //Type: select Name: dispform Value: 1
            $childData = array(
                'perid' => $personInsert,
