                ...
                <table class="table" id="myTableAll">
                    <thead class="table-light">
                        <tr>
                            ...
                            <th class="align-middle text-start" scope='col'>สถาบันมีความประสงค์รับเงินอุดหนุนจาก กสศ.</th>
                            <th class="align-middle text-start" scope='col'>ความประสงค์ปฏิบัติตามเงื่อนไขการรับทุนส่งเสริมการศึกษาหรือไม่</th>
                            <th>แก้ไข</th>
                        </tr>
                    </thead>
                    <tbody>
                        ...
                        while ($row = mysqli_fetch_assoc($results)) {
                            ...
                            echo "<td class='align-middle text-start'><a href='?page=6.2inststay/index&function=edit&perid=" . $row['perid'] . "&instid=" . $row['instid'] . "' class='btn btn-warning text-white'><i class='fas fa-edit'></i> แก้ไข</a></td>";
                            echo "";
                            $counter++;
                        }
                        ?>
