                ...
                <table class="table responsive nowrap" id="myTableAll">
                    <thead class="table-light">
                        <tr>
                            ...
                            <th class="align-middle text-start" >ชื่อ-นามสกุล บุคคล</th>
                            <th class="align-middle text-start" >รหัสสถาบัน</th>
                            <th class="align-middle text-start" >ชื่อสถาบัน</th>
                            <th class="align-middle text-start" >วันที่เข้ารับการช่วยเหลือ</th>
                            <th class="align-middle text-start" >ลักษณะที่พักอาศัยในสถาบัน</th>
                            <th class="align-middle text-start" >สถาบันให้ความช่วยเหลือด้วยวิธีเงินสด</th>
                            <th class="align-middle text-start" >สถาบันให้ความช่วยเหลือด้วยวิธีสิ่งของ</th>
                            <th class="align-middle text-start" >สถาบันให้ความช่วยเหลือด้วยวิธีที่พักอาศัย</th>
                            <th class="align-middle text-start" >สถาบันให้ความช่วยเหลือด้วยวิธีอาหาร</th>
                            <th class="align-middle text-start" >สถาบันให้ความช่วยเหลือด้วยวิธีการเดินทาง</th>
                            <th class="align-middle text-start" >สถาบันให้ความช่วยเหลือด้วยวิธีการศึกษา</th>
                            <th class="align-middle text-start" >สถาบันให้ความช่วยเหลือด้วยวิธีสุขภาพ</th>
                            <th class="align-middle text-start" >สถาบันมีรายจ่ายเฉลี่ยในการดูแลนักเรียน</th>
                            <th class="align-middle text-start" >สถาบันมีความประสงค์รับเงินอุดหนุนจาก กสศ.
                    ...
                    <tbody>
                        ...
                        while ($row = mysqli_fetch_assoc($results)) {
                            echo "<tr id='" . $row['perid'] . "' data-id='" . $row['perid'] . "'>";
                            ...
                            echo "<td class='align-middle text-center'><a href='?page=" . $_GET['page'] . "&function=edit&perid=" . $row['perid'] . "' class='btn btn-sm btn-warning'><i class='fas fa-edit'></i></a> ";
                            echo "<button class='btn btn-sm btn-danger' onclick='deletePerson2(" . $row['perid'] . ", \"" . $row['name'] . "\", \"" . $row['sname'] . "\", \"inststay\", \"instid\")'><i class='fas fa-trash'></i></button></td>";
                            echo "</tr>";
                            $counter++;
                        }
                        ?>
