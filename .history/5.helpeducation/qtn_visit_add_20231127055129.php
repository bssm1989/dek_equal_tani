                    ...
                    success: function(response) {
                        if (response.success) {
                            ...
                            Swal.fire({
                                ...
                                // Go to the next page
                                // window.location.href = "?page=5.helpeducation&function=add&perid2=" + data['perid'] + "&tab=1";
                            });
                        } else {
                            // Show error message
                            Swal.fire({
...
<?php if ($tab == 1 || $hheduid) { ?>
    <br>
    <div class="row justify-content-between card-header text-right mb-0">
        <div class="col-auto">
            <h4 class="app-page-title mb-0">ประวัติการได้รับความช่วยเหลือด้านการศึกษา ของ <?php echo $person_fullname; ?></h4>
        </div>
        <div class="col-auto">
