...
// Determine the column for the SQL query based on the existence and value of hheduid
$column = isset($_GET["hheduid"]) && $_GET["hheduid"] != "" ? "hh.hheduid" : "hh.perid";
...
if ($_GET["tab"] == "1") {
    ...
    $sql = "SELECT hh.hheduid, hh.perid, hh.eduid, hh.hedulev, hh.hedusemester, hh.hedufundtyp, hh.hedumoney, hh.hedudetail,
            ...
            WHERE $column = " . ($_GET["hheduid"] ?? $_GET["perid2"]);
} else if ($hheduid) {
    // Construct your SQL query based on hheduid
    $sql = "SELECT hh.hheduid, hh.perid, hh.eduid, hh.hedulev, hh.hedusemester, hh.hedufundtyp, hh.hedumoney, hh.hedudetail,
            p.perid AS person_perid, p.pid, t.titnme, p.name, p.sname,
            c.plcnmegen, df.dispfrmnme, el.edulevnme,
            hh.recorded_by, hh.recorded_date,
...
<ul class="nav nav-tabs">
  <li class="nav-item">
    <a class="nav-link "  href="?page=2.person2&function=add&perid2=<?= $heduid ?>&tab=1">2.person</a>
  </li>
    <li class="nav-item">
    ...
    <li class="nav-item">
        ...
        <a class="nav-link" href="?page=4.works&function=add&perid2=<?= $heduid ?>&tab=1">4.works</a>
    </li>
    <li class="nav-item">
    ...
    <li class="nav-item">
        <a class="nav-link" href="?page=6.1institute&function=add&perid2=<?= $heduid ?>&tab=1">6.1institute</a>
    </li>
    <li class="nav-item">
        <a class="nav-link" href="?page=7.history_help_job&function=add&perid2=<?= $heduid ?>&tab=1">7.history_help_job</a>
    </li>
    <li class="nav-item">
        <a class="nav-link" href="?page=8.htraining&function=add&perid2=<?= $heduid ?>&tab=1">8.htraining</a>
    </li>
    <li class="nav-item">
        <a class="nav-link" href="?page=9.hfolowup&function=add&perid2=<?= $heduid ?>&tab=1">9.hfolowup</a>
    </li>
...
<div class="mb-0 text-right row justify-content-between card-header">
    <div class="col-auto">
        <h4 class="mb-0 app-page-title">จัดการข้อมูลประวัติการได้รับความ
        ...
        <div class="p-4 shadow-sm app-card app-card-settings">
            ...
            <div class="app-card-body">
                <h5 class="pt-4 mt-3 mb-0 mb-3 text-center app-page-title text-info mt-md-0 pt-md-0">
                    <b>จัดการข้อมูลประวัติการได้รับความช่วยเหลือด้านการศึกษา</b>
                </h5>
