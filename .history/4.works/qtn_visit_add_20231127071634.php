...
$hwrkid = $_GET["perid"] ? $_GET["perid"] : $_GET[$tab]==2?$_GET["hwrkid"]:"";
...
<?php if ($tab >0 || $hwrkid) { ?>
   ...
   echo "perid2". $perid;
    // Query to fetch data from person table
   $sql = "SELECT 
                    ...
                    ?>
                        ...
                        <tr id="row<?= $hwrkid ?>" data-id="<?= $hwrkid ?>">
                            ...
                            <td>
                                ...
                                <a href="?page=<?= $_GET['page'] ?>&function=add&tab=2&perid2=<?= $row['perid'] ?>&hwrkid=<?= $row['hwrkid'] ?>&tab=2" class="btn btn-warning text-white"><i class="fas fa-edit"></i></a>';
