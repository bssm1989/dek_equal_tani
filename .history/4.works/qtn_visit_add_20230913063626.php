...
//  -->
                <form name="frmScreening" id="frmScreening" method="post" action="" enctype="" onSubmit="" target="">
                    ...
                    <!-- จังหวัดที่ทำงาน -->
                    <div class="col-12 col-sm-4 mb-3">
                        <label for="wrknme">จังหวัดที่ทำงาน</label>

                        <input type="text" class="form-control" name="province_name" id="province_name" value="<?php echo $province_name; ?>" required>
                    </div>
                    <!-- // • รหัสบุคคล รหัสเด็ก
// • รหัสอาชีพ
// • ชื่อสถานประกอบการ
// • จังหวัดที่ท างาน
// • ท างานในต าแหน่ง
// • ปีที่เริ่มประกอบอาชีพ
// • ท างานเป็นระยะเวลกี่ปีกี่เดือน
// • ท างานเป็นระยะเวลกี่ปีกี่เดือน
// • ปีที่ลาออก
// • เหตุผลที่ลาออก
...
// occ	อาชีพ				
// ชื่อฟิลด์	ประเภทข้อมูล	ความยาว	ความหมาย	PK/FK	คำอธิบายเพิ่มเติม
// occid	int	2	รหัสอาชีพ	PK	
// occnme	varchar	50	ชื่ออาชีพ	 -->
                    <div class="col-12 col-sm-4 mb-3">
