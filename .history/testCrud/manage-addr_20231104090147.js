class AddressDropdowns {
  ...
  this.colDiv1.classList.add("col-12", "col-sm-4","col-sm-4");

  this.colDiv2 = document.createElement("div");
  this.colDiv2.classList.add("col-12", "col-sm-4","col-sm-4");

  this.colDiv3 = document.createElement("div");
  this.colDiv3.classList.add("col-12", "col-sm-4","col-sm-4");
