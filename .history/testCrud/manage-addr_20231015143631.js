class AddressDropdowns {
  ...
  init() {
    ...
    // Create a single column for the entire row
    ...
    // Append the labels and dropdowns to the same column
    colDiv.appendChild(provinceLabel);
    colDiv.appendChild(this.provinceSelect);
    colDiv.appendChild(amphurLabel);
    colDiv.appendChild(this.amphurSelect);
    colDiv.appendChild(tambonLabel);
    colDiv.appendChild(this.tambonSelect);
