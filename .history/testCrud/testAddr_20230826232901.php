  ...
  $(document).ready(function() {
    ...
    $('#editForm').validate({
      ...
      messages: {
        ...
        'addr1-addressCode': 'Please select a complete address.',
        'addr2-addressCode': 'Please select a complete address.',
        'addr3-addressCode': 'Please select a complete address.',
      },
