<?php
$staff_id = $_GET["staff"]; // Get staff ID from the page showing the list of staff
...
if ($staff_id) {
    $sql = "SELECT
                ...
                titname.titnme, staffpos.staffposnme
                ,staff.recorded_by, staff.recorded_date,staff.modified_by, staff.modified_date 
            FROM staff
                        ...
                        success: function(response) {
                            if (response.success) {
                                ...
                                Swal.fire({
                                    ...
                                    // Go to the next page
                                    // window.location.href = "?page=11.staff&function=add&perid2=" + data['perid'] + "&tab=1";
                                });
                            } else {
                                // Show error message
                                Swal.fire({
