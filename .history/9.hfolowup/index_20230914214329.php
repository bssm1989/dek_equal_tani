                    ...
                    <tbody>
                        ...
                        <tr id="row<?=$row['hflwid']?>" data-id="<?= $row['hflwid'] ?>">
                            ...
                            <td class="align-middle text-center">
                                ...
                                <button type="button" class="btn btn-danger" onclick="deletePerson2('<?=$row['hflwid']?>', '<?=$row['participant_name']?>', '<?=$row['hflwdetail']?>', 'hfolowup', 'hflwid')"><i class="fas fa-trash-alt"></i></button>
                            </td>
