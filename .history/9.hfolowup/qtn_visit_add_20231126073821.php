...
<ul class="nav nav-tabs">
  <li class="nav-item">
    <a class="nav-link "  href="?page=2.person2&function=add&perid2=<?= $hflwid ?>">2.person</a>
  </li>
    <li class="nav-item">
    ...
    <li class="nav-item">
        ...
        <a class="nav-link" href="?page=4.works&function=add&perid2=<?= $hflwid ?>">4.works</a>
    </li>
    <li class="nav-item">
    ...
    <li class="nav-item">
        <a class="nav-link" href="?page=6.1institute&function=add&perid2=<?= $hflwid ?>">6.1institute</a>
    </li>
    <li class="nav-item">
        <a class="nav-link" href="?page=7.history_help_job&function=add&perid2=<?= $hflwid ?>">7.history_help_job</a>
    </li>
    <li class="nav-item">
        <a class="nav-link" href="?page=8.htraining&function=add&perid2=<?= $hflwid ?>">8.htraining</a>
    </li>
    <li class="nav-item">
