                            ...
                            <tr id="row<?= $row['hflwid'] ?>" data-id="<?= $row['hflwid'] ?>">
                                ...
                                <td class="align-middle text-center">
                                    <div class="btn-group" role="group">
                                        ...
                                        <button type="button" class="btn btn-sm btn-danger text-white" onclick="deletePerson2('<?= $row['hflwid'] ?>', '<?= $row['participant_name'] ?>', '<?= $row['hflwdetail'] ?>', 'hfolowup', 'hflwid')"><i class="fas fa-trash-alt"></i></button>
                                    </div>
                                </td>
