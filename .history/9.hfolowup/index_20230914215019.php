                ...
                <table class="table responsive nowrap" id="myTableAll">
                    ...
                    <tbody>
                        ...
                        <?php foreach ($results as $row) : ?>
                            <tr id="row<?= $row['hflwid'] ?>" data-id="<?= $row['hflwid'] ?>">
                                ...
                                <td class="align-middle text-center">
                                    <div class="btn-group" role="group">
                                        <a href="?page=<?= $_GET['page'] ?>&function=edit&hflwid=<?= $row['hflwid'] ?>" class="btn btn-warning text-white"><i class="fas fa-edit"></i></a>
                                        <button type="button" class="btn btn-sm btn-warning text-white" onclick="deletePerson2('<?= $row['hflwid'] ?>', '<?= $row['participant_name'] ?>', '<?= $row['hflwdetail'] ?>', 'hfolowup', 'hflwid')"><i class="fas fa-trash-alt"></i></button>
                                    </div>
                                </td>
