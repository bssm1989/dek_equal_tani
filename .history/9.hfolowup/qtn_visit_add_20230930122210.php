...
• รายละเอียดการติดตาม/เยี่ยมเยียน -->
                <form name="frmScreening" id="frmScreening" method="post" action="" enctype="" onSubmit="" target="">
                    ...
                    <div class="col-12 col-sm-4 mb-3">
                        ...
                        <!-- //div group -->
                        <!-- input hidden hflwid -->
                        <input type="hidden" class="form-control" name="hflwid" id="hflwid" placeholder="" value="<?php echo $hflwid; ?>" readonly="true" required>
        ...
        $("#frmScreening").validate({
            ...
            submitHandler: function(form) {
                ...
                function performAjaxRequest(data) {
                    ...
                    data['hflwdteend'] = data['htrndteend'].replace(/-/g, "");
