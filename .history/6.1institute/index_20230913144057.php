                    ...
                    <table class="table" id="myTableAll">
                        ...
                        <tbody>
                            ...
                            while ($row = mysqli_fetch_assoc($results)) {
                                ...
                                echo "<td class='align-middle text-start'><a href='?page=" . $_GET['page'] . "&function=edit&instid=" . $row['instid'] . "' class='btn btn-warning text-white'><i class='fas fa-edit'></i></a></td>";
                                echo "</tr>";
                                ?>
                            <?php
                                $counter++;
