        ...
        <div class="app-card app-card-settings shadow-sm p-4">
            ...
            <div class="app-card-body">
                ...
                <form name="frmInstitute" id="frmInstitute" method="post" action="" enctype="" onSubmit="" target="">
                    ...
                    <hr>
                    <button class="mt-3 btn app-btn-primary" type="button" onClick="saveInstitute();">บันทึก</button>
                    <button class="mt-3 btn btn-danger text-white" type="reset" onClick=" clearForm();">เคลียร์หน้าจอ</button>
