                        ...
                        <tbody>
                            ...
                            while ($row = mysqli_fetch_assoc($results)) {
                                ...
                                echo "<td class='align-middle text-start'><a href='?page=" . $_GET['page'] . "&function=edit&instid=" . $row['instid'] . "' class='btn btn-warning text-white'><i class='fas fa-edit'></i></a>"
                                    . "<button type='button' class='btn btn-sm btn-danger text-white' onclick='deletePerson2(" . $row['instid'] . ", \"" . $row['instname'] . "\", \"" . $row['inssname'] . "\", \"institute\", \"instid\")'><i class='fas fa-trash-alt'></i></button></td>";
                                echo "</tr>";
                            ?>
                            <?php
                                $counter++;
