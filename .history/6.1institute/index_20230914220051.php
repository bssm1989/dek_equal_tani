                    ...
                    <table id="myTableAll" class="display responsive nowrap" style="width:100%">
                        <thead class="table-light">
                            <tr>
                                ...
                                <th class="align-middle text-start" >จังหวัดที่ตั้งของสถาบัน</th>
                                <th class="align-middle text-start" >ชื่อผู้รับผิดชอบสถาบัน</th>
                                ...
                                <th class="align-middle text-start" scope='col'>แก้ไข</th>
                            </tr>
                        </thead>
                        <tbody>
                            <?php
                            ...
                            while ($row = mysqli_fetch_assoc($results)) {
                                echo "<tr id='" . $row['instid'] . "' data-id='" . $row['instid'] . "'>";
                                ...
                                echo "<td class='align-middle text-start'><a href='?page=" . $_GET['page'] . "&function=edit&instid=" . $row['instid'] . "' class='btn btn-warning text-white'><i class='fas fa-edit'></i></a>"
                                    . "<button type='button' class='btn btn-sm btn-danger text-white' onclick='deletePerson2(" . $row['instid'] . ", \"" . $row['instname'] . "\", \"" . $row['inssname'] . "\", \"institute\", \"instid\")'><i class='fas fa-trash-alt'></i></button></div></td>";
                                echo "</tr>";
                            ?>
                            <?php
                                $counter++;
