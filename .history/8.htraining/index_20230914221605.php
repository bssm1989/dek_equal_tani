                    ...
                    <table class="table responsive nowrap" id="myTableAll">
                        ...
                        <tbody>
                            <?php foreach ($results as $row) : ?>
                                <tr id="row<?= $row['hhtrnid'] ?>" data-id="<?= $row['hhtrnid'] ?>">
                                    ...
                                    <td class="align-middle text-center">
                                        ...
                                        <a href="?page=<?= $_GET['page'] ?>&function=add&hhtrnid=<?= $row['hhtrnid'] ?>" class="btn btn-warning text-white"><i class="fas fa-edit"></i></a>
                                        <button type="button" class="btn btn-sm btn-danger text-white" onclick="deletePerson2('<?= $row['hhtrnid'] ?>', '<?= $row['participant_name'] ?>', '<?= $row['htrntit'] ?>', 'htraining', 'hhtrnid')"><i class="fas fa-trash-alt"></i></button>
                                        </div>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
