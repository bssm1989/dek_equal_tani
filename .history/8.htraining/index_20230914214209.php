                            ...
                            <?php foreach ($results as $row) : ?>
                                <tr id="row<?= $row['hhtrnid'] ?>" data-id="<?= $row['hhtrnid'] ?>">
                                    ...
                                    <td class="align-middle text-center">
                                        ...
                                        <button type="button" class="btn btn-danger" onclick="deletePerson2('<?= $row['hhtrnid'] ?>', '<?= $row['participant_name'] ?>', '<?= $row['htrntit'] ?>', 'htraining', 'hhtrnid')"><i class="fas fa-trash-alt"></i></button>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
