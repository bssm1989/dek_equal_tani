...
• รายละเอียดการติดตาม/เยี่ยมเยียน -->
                <form name="frmScreening" id="frmScreening" method="post" action="" enctype="" onSubmit="" target="">
                    ...
                    <div class="col-12 col-sm-4 mb-3">
                        ...
                        <div class="col-12 col-sm-4 mb-3">
                            <label for="prvSelect">บุคคล</label>
                            <!-- //div group -->
                            <!-- input hidden hhtrnid -->
                            <div class="input-group">
                                <!-- Search for a person... to thai -->
                                <input type="text" id="prvSelect" name="personName" class="form-control" placeholder="ค้นหาบุคคล" value="<?php echo $participant_name; ?>" required>

                            </div>
                            <div id="prvDropdown" class="dropdown-menu" aria-labelledby="prvSelect"></div>
