                ...
                <form name="frmScreening" id="frmScreening" method="post" action="" enctype="" onSubmit="" target="">
                    ...
                    <div class="col-12 col-sm-4 mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" name="prvid" id="prvidSelect" placeholder="จังหวัดที่อบรม" value="<?php echo $prvid; ?>" required>
                            
                        </div>
                        <div id="prvDropdown" class="dropdown-menu" aria-labelledby="prvidSelect">


                                        <!-- Dropdown items will be populated here -->
                                </div>
                                <input type="hidden" id="prvid" name="prvid" /> <!-- Hidden input to store the selected ID -->
                            </div>
                            ...
                            <script>
                                ...
                                //                                                                                   iiii                                                                            d::::::d                                                        
                                //                                                                                                                                                                   d:::::d                                                         
                                // ppppp   ppppppppp   rrrrr   rrrrrrrrr      ooooooooooo vvvvvvv           vvvvvvviiiiiiinnnn  nnnnnnnn        cccccccccccccccc    eeeeeeeeeeee             ddddddddd:::::drrrrr   rrrrrrrrr      ooooooooooo   ppppp   ppppppppp   
                                // p::::ppp:::::::::p  r::::rrr:::::::::r   oo:::::::::::oov:::::v         v:::::v i:::::in:::nn::::::::nn    cc:::::::::::::::c  ee::::::::::::ee         dd::::::::::::::dr::::rrr:::::::::r   oo:::::::::::oo p::::ppp:::::::::p  
                                // p:::::::::::::::::p r:::::::::::::::::r o:::::::::::::::ov:::::v       v:::::v   i::::in::::::::::::::nn  c:::::::::::::::::c e::::::eeeee:::::ee      d::::::::::::::::dr:::::::::::::::::r o:::::::::::::::op:::::::::::::::::p 
                                // pp::::::ppppp::::::prr::::::rrrrr::::::ro:::::ooooo:::::o v:::::v     v:::::v    i::::inn:::::::::::::::nc:::::::cccccc:::::ce::::::e     e:::::e     d:::::::ddddd:::::drr::::::rrrrr::::::ro:::::ooooo:::::opp::::::ppppp::::::p
                                //  p:::::p     p:::::p r:::::r     r:::::ro::::o     o::::o  v:::::v   v:::::v     i::::i  n:::::nnnn:::::nc::::::c     ccccccce:::::::eeeee::::::e     d::::::d    d:::::d r:::::r     r:::::ro::::o     o::::o p:::::p     p:::::p
                                //  p:::::p     p:::::p r:::::r     rrrrrrro::::o     o::::o   v:::::v v:::::v      i::::i  n::::n    n::::nc:::::c             e:::::::::::::::::e      d:::::d     d:::::d r:::::r     rrrrrrro::::o     o::::o p:::::p     p:::::p
                                //  p:::::p     p:::::p r:::::r            o::::o     o::::o    v:::::v:::::v       i::::i  n::::n    n::::nc:::::c             e::::::eeeeeeeeeee       d:::::d     d:::::d r:::::r            o::::o     o::::o p:::::p     p:::::p
                                //  p:::::p    p::::::p r:::::r            o::::o     o::::o     v:::::::::v        i::::i  n::::n    n::::nc::::::c     ccccccce:::::::e                d:::::d     d:::::d r:::::r            o::::o     o::::o p:::::p    p::::::p
                                //  p:::::ppppp:::::::p r:::::r            o:::::ooooo:::::o      v:::::::v        i::::::i n::::n    n::::nc:::::::cccccc:::::ce::::::::e               d::::::ddddd::::::ddr:::::r            o:::::ooooo:::::o p:::::ppppp:::::::p
                                //  p::::::::::::::::p  r:::::r            o:::::::::::::::o       v:::::v         i::::::i n::::n    n::::n c:::::::::::::::::c e::::::::eeeeeeee        d:::::::::::::::::dr:::::r            o:::::::::::::::o p::::::::::::::::p 
                                //  p::::::::::::::pp   r:::::r             oo:::::::::::oo         v:::v          i::::::i n::::n    n::::n  cc:::::::::::::::c  ee:::::::::::::e         d:::::::::ddd::::dr:::::r             oo:::::::::::oo  p::::::::::::::pp  
                                //  p::::::pppppppp     rrrrrrr               ooooooooooo            vvv           iiiiiiii nnnnnn    nnnnnn    cccccccccccccccc    eeeeeeeeeeeeee          ddddddddd   dddddrrrrrrr               ooooooooooo    p::::::pppppppp    
                                //  p:::::p                                                                                                                                                                                                       p:::::p            
                                //  p:::::p                                                                                                                                                                                                       p:::::p            
                                // p:::::::p                                                                                                                                                                                                     p:::::::p           
                                // p:::::::p                                                                                                                                                                                                     p:::::::p           
                                            ...
                                            success: function(data) {
                                                ...
                                                data.forEach(function(result) {
                                                    ...
                                                    option.on('click', function() {
                                                        var selectedValue = $(this).attr('data-value');
                                                        var selectedText = $(this).text();
                                                        $('#prvidSelect').val(selectedText); // Set the selected text in the input field
                                                        $('#perid').val(selectedValue); // Set the selected ID in the hidden input
                                                        $('#prvDropdown').hide();
