                    ...
                    <table class="table" id="myTableAll">
                        ...
                        <tbody>
                            <?php foreach ($results as $rows) :
                                ...
                                $actplc = $rows["actplc"];
                                $place_village = $rows["place_village"];
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td class="align-middle text-center">
                                        <a href="?page=<?= $_GET['page'] ?>&function=edit&actid=<?= $actid ?>" class="btn btn-warning text-white"><i class="fas fa-edit"></i></a>
                                        <a href="?page=<?= $_GET['page'] ?>&function=delete&actid=<?= $actid ?>" class="btn btn-danger text-white" onclick="return confirm('ต้องการลบข้อมูลนี้หรือไม่?')"><i class="fas fa-trash-alt"></i></a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
