                            ...
                            ?>
                                <tr>
                                    ...
                                    <td class="align-middle text-center">
                                        <a href="?page=<?= $_GET['page'] ?>&function=edit&actid=<?= $actid ?>" class="btn btn-sm btn-warning text-white"><i class="fas fa-edit"></i></a>
                                        <button type="button" class="btn btn-sm btn-danger text-white" onclick="deletePerson2('<?= $actid ?>', '<?= $actnme ?>', '<?= $actdetail ?>', 'activity', 'actid')"><i class="fas fa-trash-alt"></i></button>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
