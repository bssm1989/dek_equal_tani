...
*/
        ...
        $peridToUpdate = isset($_POST['actid']) ? $_POST['actid'] : '';
...
//make  get perid to make condition in update
        $personid = $_POST['actid'];
        $updatePersonCondition = "actid = $personid";
               
        
        $updatedPerson = updateData('activity', $personDataToUpdate, $updatePersonCondition, $conn,$personid);
