...
<div class="row justify-content-between card-header text-right mb-0">
    <div class="col-auto">
        <h4 class="app-page-title mb-0"> ..</h4>
    </div>
    <div class="col-auto">
...
<hr class="mb-0">
<div class="row gy-4">
    <form name="frmUser" id="frmUser" method="post" action="./admin_profile/perupfile.php" enctype="multipart/form-data"
        onSubmit="" target="">
        <div class="row">
                                    ...
                                    <div class="item-data">
                                        ...
                                        <span style="position: relative; top: 5px;">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <?php if($file_resnme) echo "<a href=\"./admin_profile/perdelfile.php?ofcid=".$ofcid."&filename=".$picname."\" type='button' class='btn app-btn-secondary' >ลบ</a>"; ?>
...
function changeUser() {
    var xmlhttp = Inint_AJAX();
    //alert("xxxxxxxxxxx");
    var Url = "./admin_profile/profile_crud.php";
    var POSTBody = "";
    POSTBody += "ofcid=" + document.frmUser.ofcid.value;
    ...
    xmlhttp.onreadystatechange = function() {
        if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
            ...
            if (decoded_data['checkSave'] == "yes") {
                ...
                Swal.fire({
                    text: 'ไม่สามารถบันทึกข้อมูลได้ กรุณากรอกข้อมูลใหม่',
                    icon: 'error',
                    showConfirmButton: false,
                    timer: 2000
                })
