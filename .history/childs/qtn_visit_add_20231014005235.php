<?php
    ...
    if($ofcid){
        ...
        if($rows = mysqli_fetch_array($result)){
            ...
            // $recorded_date 	= substr($rows["recorded_date"],6,2)."-".substr($rows["recorded_date"],4,2)."-".substr($rows["recorded_date"],0,4);	
            // $modified_date	 	= substr($rows["modified_date	"],6,2)."-".substr($rows["modified_date	"],4,2)."-".substr($rows["modified_date	"],0,4);
        }
    }else{
