            ...
            <div class="app-content pt-3 p-md-3 p-lg-4">
                <div class="container-xl">
                    <?php 
                        ...
                        }else if(isset($_GET['page']) && $_GET['page'] == '1.family'){
                            if(isset($_GET['page']) && $_GET['function'] == 'add'){
                                require '1.family/qtn_visit_add.php';
                            }else if(isset($_GET['page']) && $_GET['function'] == 'update'){
                                require '1.family/qtn_visit_add.php';
                            }else if(isset($_GET['page']) && $_GET['function'] == 'delete'){
                            }else{
                                require '1.family/index.php';
                            }
                    ...
                    else if(isset($_GET['page']) && $_GET['page'] == '7.history_help_job'){
                        if(isset($_GET['page']) && $_GET['function'] == 'add'){
                            require '7.history_help_job/qtn_visit_add.php';
                        }else if(isset($_GET['page']) && $_GET['function'] == 'update'){
                            require '7.history_help_job/qtn_visit_add.php';
                        }else if(isset($_GET['page']) && $_GET['function'] == 'delete'){
                        }else{
                            require '7.history_help_job/index.php';
                        }
                    }
