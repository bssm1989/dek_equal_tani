<?php
    ...
    if($perid){
        ...
        CONCAT(o1.`ofcnme`) AS recorded_by,p.recorded_date,CONCAT(o2.`ofcnme`) AS modified_by,p.modified_date	 
        FROM person p LEFT JOIN person_qtn_additional a ON p.perid = a.perid
        LEFT JOIN ofc o1 ON o1.ofcid=p.recorded_by
        LEFT JOIN ofc o2 ON o2.ofcid=p.modified_by";
                        ...
                        <div class="col-md-3 mb-3">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <button class="btn btn-primary text-white" type="button"
                                    onClick="if(confirm('ต้องการกำหนดพิกัดจริงหรือไม่')==true) getLocation();"><i
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 mb-3">
                            ...
                            <input type="text" class="form-control" name="modified_date" id="modified_date" placeholder=""
                                value="<?=$modified_date	?>" readonly="true" required>
                        </div>
                    </div>
    ...
    xmlhttp.onreadystatechange = function() {
        if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
            ...
            if (decoded_data['checkSave'] == "yes") {
                ...
                window.document.frmPerson.modified_by.value = decoded_data['modified_by0'];
                window.document.frmPerson.modified_date	.value = decoded_data['modified_date	0'];
