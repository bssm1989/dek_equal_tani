...
function updateData($table, $data, $condition, $conn, $id)
{
    ...
    try {
        ...
        foreach ($data as $key => $value) {
         ...
         // add session "staffid" to modified_by and put datetime to modified_date
        ...
        $user_id = $_SESSION['staffid'];
        mysqli_query($conn,"SET @user_id =$user_id,@query_value ='UPDATE hhold SET hholdid = '21', adr = '123 ถนนเมนe', soi = 'ถนนเมน2', vllid = '012', plcid = '110201', postcode = '110201', memno = '52', hhdeponid = '4', hhtypid = '4', hhrent = '102', hhflrid = '5', hhwallid = '5', hhrfid = '5', hhtoilet = '12', havagrland = '21', agrlandid = '2', hhwaterid = '3', havelect = '12', hhelectid = '2', vhcar = '2', vhcarage = '22', vhtruck = '1', vhtruckage = '1', vhtractor = '1', vhmbike = '1', vhno = '1', hitemcomputer = '2', hitemaircon = '2', hitemtvflat = '2', hitemwashmachine = '2', hitemrefrige = '2', hitemno = '2', modified_by = "1", modified_date = "2023-10-14 09:14:04" WHERE hholdid = 21'");
        $result = mysqli_query($conn, $sql);
