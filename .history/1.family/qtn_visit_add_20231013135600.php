...
-->
                ...
                <form name="frmScreening" id="frmScreening" method="post" enctype="" onSubmit="" target="">
                    ...
                    <!-- รหัสครัวเรือนมีภาระพึ่งพิง -->
                    <div class="col-12 col-sm-4 mb-3">
                        <label for="hhdeponid">รหัสครัวเรือนมีภาระพึ่งพิง</label>
                    ...
                    <!-- รหัสการอยู่อาศัย -->
                    <div class="col-12 col-sm-4 mb-3">
                        <label for="hhtypid">รหัสการอยู่อาศัย</label>
                    ...
                    <!-- รหัสวัสดุที่ใช้ทำพื้นบ้าน (ที่ไม่ใช่ใต้ถุนบ้าน) -->
                    <div class="col-12 col-sm-4 mb-3">
                        <label for="hhflrid">รหัสวัสดุที่ใช้ทำพื้นบ้าน (ที่ไม่ใช่ใต้ถุนบ้าน)</label>
                    ...
                    <!-- รหัสวัสดุที่ใช้ทำฝาบ้าน -->
                    <div class="col-12 col-sm-4 mb-3">
                        <label for="hhwallid">รหัสวัสดุที่ใช้ทำฝาบ้าน</label>
                    ...
                    <!-- รหัสวัสดุที่ใช้ทำหลังคา -->
                    <div class="col-12 col-sm-4 mb-3">
                        <label for="hhrfid">รหัสวัสดุที่ใช้ทำหลังคา</label>
                    ...
                    <!-- รหัสแหล่งน้ำดื่ม -->
                    <div class="col-12 col-sm-4 mb-3">
                        <label for="hhwaterid">รหัสแหล่งน้ำดื่ม</label>
                    ...
                    <!-- ยานพาหนะในครัวเรือน (ที่ใช้งานได้):: รถยนต์นั่งส่วนบุคคล --><div class="col-12 col-sm-4 mb-3">
                    ...
                    <!-- make select this option รถปิกอัพ/รถบรรทุกเล็ก/รถตู้ and get value for query php to make selected -->
                                <select class="form-control" name="vhtruck" id="vhtruck" required>
                                    ...
                                    <option value="1" <?php if ($vhtruck == 1) echo 'selected'; ?>>รถปิกอัพ</option>
                                    <option value="2" <?php if ($vhtruck == 2) echo 'selected'; ?>>รถบรรทุกเล็ก</option>
                                    <option value="3" <?php if ($vhtruck == 3) echo 'selected'; ?>>รถตู้</option>
                                </select>
                    ...
                    <div class="col-12 col-sm-4 mb-3">
                        ...
                        <input type="text" class="form-control" name="vhtruckage" id="vhtruckage" placeholder="" value="<?= $vhtruckage; ?>" required>
                    </div>
                    <!-- ยานพาหนะในครัวเรือน (ที่ใช้งานได้):: รถไถ/รถเกี่ยวข้าว/รถประเภทเดียวกัน -->
                    <div class="col-12 col-sm-4 mb-3">
                        <label for="vhtractor">ยานพาหนะในครัวเรือน (ที่ใช้งานได้):: รถไถ/รถเกี่ยวข้าว/รถประเภทเดียวกัน</label>
                       <select class="form-control" name="vhtractor" id="vhtractor" >
                                <option value="">เลือกยานพาหนะ</option>
                                <option value="1" <?php if ($vhtractor == 1) echo 'selected'; ?>>รถไถ</option>
                                <option value="2" <?php if ($vhtractor == 2) echo 'selected'; ?>>รถเกี่ยวข้าว</option>
                                <option value="3" <?php if ($vhtractor == 3) echo 'selected'; ?>>รถประเภทเดียวกัน</option>
                    ...
                    <div class="col-12 col-sm-4 mb-3">
                        ...
                        <input type="text" class="form-control" name="vhtractorage" id="vhtractorage" placeholder="" value="<?= $vhtractorage; ?>" required>
                    </div>
                    ...
                    <div class="col-12 col-sm-4 mb-3">
                        ...
                        <select class="form-control"  name="vhmbike" id="vhmbike" >
                            <option value="">เลือกยานพาหนะ</option>
                            <option value="1" <?php if ($vhmbike == 1) echo 'selected'; ?>>รถมอเตอร์ไซต์</option>
                            <option value="2" <?php if ($vhmbike == 2) echo 'selected'; ?>>เรือประมงพื้นบ้าน(ขนาดเล็ก)</option>
                        </select>
                    </div>
                    <!-- ยานพาหนะในครัวเรือน (ที่ใช้งานได้):: ไม่มียานพาหนะในครัวเรือน -->
                    <div class="col-12 col-sm-4 mb-3">
                        <label for="vhno">ยานพาหนะในครัวเรือน (ที่ใช้งานได้):: ไม่มียานพาหนะในครัวเรือน</label>
                        <input type="text" class="form-control" name="vhno" id="vhno" placeholder="" value="<?= $vhno; ?>" required>
                    </div>
                    <!-- ของใช้ในครัวเรือน (ที่ใช้งานได้):: คอมพิวเตอร์ -->
                    <div class="col-12 col-sm-4 mb-3">
                        <label for="hitemcomputer">ของใช้ในครัวเรือน (ที่ใช้งานได้):: คอมพิวเตอร์</label>
                        <input type="text" class="form-control" name="hitemcomputer" id="hitemcomputer" placeholder="" value="<?= $hitemcomputer; ?>" required>
                    </div>
                    <!-- ของใช้ในครัวเรือน (ที่ใช้งานได้):: แอร์ -->
                    <div class="col-12 col-sm-4 mb-3">
                        <label for="hitemaircon">ของใช้ในครัวเรือน (ที่ใช้งานได้):: แอร์</label>
                        <input type="text" class="form-control" name="hitemaircon" id="hitemaircon" placeholder="" value="<?= $hitemaircon; ?>" required>
                    </div>
                    <!-- ของใช้ในครัวเรือน (ที่ใช้งานได้):: ทีวีจอแบน -->
                    <div class="col-12 col-sm-4 mb-3">
                        <label for="hitemtvflat">ของใช้ในครัวเรือน (ที่ใช้งานได้):: ทีวีจอแบน</label>
                        <input type="text" class="form-control" name="hitemtvflat" id="hitemtvflat" placeholder="" value="<?= $hitemtvflat; ?>" required>
                    </div>

                    <!-- ของใช้ในครัวเรือน (ที่ใช้งานได้):: เครื่องซักผ้า -->
                    <div class="col-12 col-sm-4 mb-3">
                        <label for="hitemwash">ของใช้ในครัวเรือน (ที่ใช้งานได้):: เครื่องซักผ้า</label>
                        <input type="text" class="form-control" name="hitemwash" id="hitemwash" placeholder="" value="<?= $hitemwash; ?>" required>
                    </div>
                    <!-- ของใช้ในครัวเรือน (ที่ใช้งานได้):: ตู้เย็น -->
                    <div class="col-12 col-sm-4 mb-3">
                        <label for="hitemfridge">ของใช้ในครัวเรือน (ที่ใช้งานได้):: ตู้เย็น</label>
                        <input type="text" class="form-control" name="hitemfridge" id="hitemfridge" placeholder="" value="<?= $hitemfridge; ?>" required>
                    </div>
                    <!-- ของใช้ในครัวเรือน (ที่ใช้งานได้):: ไม่มีของใช้ดังกล่าว -->
                    <div class="col-12 col-sm-4 mb-3">
                        <label for="hitemno">ของใช้ในครัวเรือน (ที่ใช้งานได้):: ไม่มีของใช้ดังกล่าว</label>
                        <input type="text" class="form-control" name="hitemno" id="hitemno" placeholder="" value="<?= $hitemno; ?>" required>
                    </div>
                    ...
                    <div class="col-12 col-sm-4 mb-3">
                        ...
                        <input type="file" class="form-control" name="hhimg1" id="hhimg1" placeholder="" value="<?= $hitemno; ?>" required>
                    </div>
                    ...
                    <div class="col-12 col-sm-4 mb-3">
                        ...
                        <input type="file" class="form-control" name="hhimg2" id="hhimg2" placeholder="" value="<?= $hitemno; ?>" required>
                    </div>
