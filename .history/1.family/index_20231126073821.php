                    ...
                    <tbody>
                        ...
                        ?>
                            <tr id="row_<?= $hholdid  ?>">
                                ...
                                <td><?= $hhrfnme ?></td>
                                <td><?= $hh_toilet ?></td>
                                <!-- 0=ไม่ทำเกษตร, 1=ทำเกษตร -->
                                <td><?= $have_agr_land == 0 ? "ไม่ทำเกษตร" : "ทำเกษตร" ?></td>
                                <td><?= $agrlandnme ?></td>
                                <td><?= $hhwaternme ?></td>
                                <!-- 0=ไม่มีไฟฟ้า/ไม่มีเครื่องกำเนิดไฟฟ้าชนิดอื่น ๆ, 1=มีไฟฟ้า -->
                                <td><?= $have_elect == 0 ? "ไม่มีไฟฟ้า/ไม่มีเครื่องกำเนิดไฟฟ้าชนิดอื่น ๆ" : "มีไฟฟ้า" ?></td>
                                <td><?= $hhelectnme ?></td>
                                <td><?= $vh_car == 1 ? "มี" : "ไม่มี" ?></td>
                                <td><?= $vh_car_age == 1 ? "อายุเกิน 15 ปี" : "อายุไม่เกิน 15 ปี" ?></td>
                                <td><?= $vh_truck == 1 ? "มี" : "ไม่มี" ?></td>
                                <td><?= $vh_truck_age == 1 ? "อายุเกิน 15 ปี" : "อายุไม่เกิน 15 ปี" ?></td>
                                <td><?= $vh_tractor == 1 ? "มี" : "ไม่มี" ?></td>
                                <td><?= $vh_tractor_age == 1 ? "อายุเกิน 15 ปี" : "อายุไม่เกิน 15 ปี" ?></td>
                                <td><?= $vh_mbike == 1 ? "มี" : "ไม่มี" ?></td>
                                <td><?= $vh_no == 1 ? "มี" : "ไม่มี" ?></td>
                                <td><?= $hitem_computer == 1 ? "มี" : "ไม่มี" ?></td>
                                <td><?= $hitem_aircon == 1 ? "มี" : "ไม่มี" ?></td>
                                <td><?= $hitem_tvflat == 1 ? "มี" : "ไม่มี" ?></td>
                                <td><?= $hitem_washmachine == 1 ? "มี" : "ไม่มี" ?></td>
                                <td><?= $hitem_refrige == 1 ? "มี" : "ไม่มี" ?></td>
                                <td><?= $hitem_no == 1 ? "มี" : "ไม่มี" ?></td>
                                <td>

                                    <div class="btn-group" role="group">
                                        <a href="?page=<?= $_GET['page'] ?>&function=add&perid2=<?= $hholdid ?>" class="btn btn-warning text-white"><i class="fas fa-edit"></i></a>
...
<script>
    ...
    function deletePersonData(id) {
        ...
        $.ajax({
            type: "POST",
            url: "1.family/delete_family.php",
