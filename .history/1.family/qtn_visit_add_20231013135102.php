...
-->
                ...
                <form name="frmScreening" id="frmScreening" method="post" enctype="" onSubmit="" target="">
                    ...
                    <div class="col-12 col-sm-4 mb-3">
                        ...
                        <input type="text" class="form-control" name="vhtractor" id="vhtractor" placeholder="" value="<?= $vhtractor; ?>" required>
                    </div>
                    <!-- อายุ:: รถไถ/รถเกี่ยวข้าว/รถประเภทเดียวกัน -->
                    <div class="col-12 col-sm-4 mb-3">
                    ...
                    <div class="col-12 col-sm-4 mb-3">
                        ...
                        <input type="text" class="form-control" name="vhmbike" id="vhmbike" placeholder="" value="<?= $vhmbike; ?>" required>
                    </div>
                    <!-- ยานพาหนะในครัวเรือน (ที่ใช้งานได้):: ไม่มียานพาหนะในครัวเรือน -->
                    <div class="col-12 col-sm-4 mb-3">
