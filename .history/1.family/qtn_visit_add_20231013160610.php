...
-->
                ...
                <form name="frmScreening" id="frmScreening" method="post" enctype="" onSubmit="" target="">
                    ...
                    <div class="col-12 col-sm-4 mb-3">
                        ...
                        <select class="form-control" name="hitemwash" id="hitemwash" >
                            <option value="">เลือกของใช้</option>
                            <option value="1" <?php if ($hitemwash == 1) echo 'selected'; ?>>มี</option>
                            <option value="2" <?php if ($hitemwash == 2) echo 'selected'; ?>>ไม่มี</option>   
                        </select>
                    </div>
                    <!-- ของใช้ในครัวเรือน (ที่ใช้งานได้):: ตู้เย็น -->
                    <div class="col-12 col-sm-4 mb-3">
                        ...
                        <select class="form-control" name="hitemfridge" id="hitemfridge" >
                            <option value="">เลือกของใช้</option>
                            <option value="1" <?php if ($hitemfridge == 1) echo 'selected'; ?>>มี</option>
                            <option value="2" <?php if ($hitemfridge == 2) echo 'selected'; ?>>ไม่มี</option>   
                        </select>
                    </div>
                    <!-- ของใช้ในครัวเรือน (ที่ใช้งานได้):: ไม่มีของใช้ดังกล่าว -->
                    <div class="col-12 col-sm-4 mb-3">
