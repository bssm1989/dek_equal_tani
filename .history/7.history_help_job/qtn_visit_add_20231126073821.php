...
• ลักษณะการช่วยเหลือ:: ส่งต่อให้หน่วยงาน
 ...
 <ul class="nav nav-tabs">
  <li class="nav-item">
    <a class="nav-link "  href="?page=2.person2&function=add&perid2=<?= $hhjobid ?>">2.person</a>
  </li>
    <li class="nav-item">
    ...
    <li class="nav-item">
        ...
        <a class="nav-link" href="?page=4.works&function=add&perid2=<?= $hhjobid ?>">4.works</a>
    </li>
    <li class="nav-item">
    ...
    <li class="nav-item">
        <a class="nav-link" href="?page=6.1institute&function=add&perid2=<?= $hhjobid ?>">6.1institute</a>
    </li>
    <li class="nav-item">
        <a class="nav-link active" aria-current="page" href="#"> 7.history_help_job</a>
    </li>
    <li class="nav-item">
        <a class="nav-link" href="?page=8.htraining&function=add&perid2=<?= $hhjobid ?>">8.htraining</a>
    </li>
    <li class="nav-item">
        <a class="nav-link" href="?page=9.hfolowup&function=add&perid2=<?= $hhjobid ?>">9.hfolowup</a>
    </li>
