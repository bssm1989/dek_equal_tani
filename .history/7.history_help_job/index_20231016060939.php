                            ...
                            ?>
                                ...
                                <td class="align-middle text-center"><?= $hhjobid ?></td>
                                    ...
                                    <td class="align-middle text-center">
                                        ...
                                        <a href="?page=<?= $_GET['page'] ?>&function=add&hhjobid=<?= $hhjobid ?>" class="btn btn-warning text-white"><i class="fas fa-edit"></i></a>
                                        <button type="button" class="btn btn-sm btn-danger text-white" onclick="deletePerson2(<?= $hhjobid ?>, '<?= $name ?>', '<?= $sname ?>', 'hhelpjob', 'hhjobid')"><i class="fas fa-trash-alt"></i></button>   
                                        </div>
                                    </td>
                            </tr>
                            <?php
...
<script language=Javascript>
    ...
    function deletePersonData(id, table, fillId) {
        ...
        $.ajax({
            type: "POST",
            url: "7.history_help_job/delete_person.php",
            data: {
                id: id,
                table: table,
                fillId: fillId
