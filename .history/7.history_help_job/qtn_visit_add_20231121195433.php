<?php
$hhjobid = $_GET["hhjobid"]? $_GET["perid"] : "";
$perid2 = $_GET["perid2"] ? $_GET["perid2"] : "";
$tab = $_GET["tab"] ? $_GET["tab"] : ""; // Get hhjobid from page showing the list of hhelpjob
...
• ลักษณะการช่วยเหลือ:: ส่งต่อให้หน่วยงาน
 ...
 <ul class="nav nav-tabs">
  <li class="nav-item">
    <a class="nav-link "  href="?page=2.person2&function=add&perid=<?= $hhjobid ?>">2.person</a>
  </li>
    <li class="nav-item">
    ...
    <li class="nav-item">
        ...
        <a class="nav-link" href="?page=4.works&function=add&perid=<?= $hhjobid ?>">4.works</a>
    </li>
    <li class="nav-item">
        <!-- ?page=5.helpeducation&function=add&perid=3 -->
        <a class="nav-link" href="?page=5.helpeducation&function=add&perid=<?= $hhjobid ?>">5.helpeducation</a>
    </li>
    <li class="nav-item">
        <a class="nav-link" href="?page=6.1institute&function=add&perid=<?= $hhjobid ?>">6.1institute</a>
    </li>
    <li class="nav-item">
        <a class="nav-link active" aria-current="page" href="#"> 7.history_help_job</a>
    </li>
    <li class="nav-item">
        <a class="nav-link" href="?page=8.htraining&function=add&perid=<?= $hhjobid ?>">8.htraining</a>
    </li>
    <li class="nav-item">
        <a class="nav-link" href="?page=9.hfolowup&function=add&perid=<?= $hhjobid ?>">9.hfolowup</a>
    </li>
...
• รายละเอียดการช่วยเหลือ -->
                <form name="frmScreening" id="frmScreening" method="post" action="" enctype="" onSubmit="" target="">
                    ...
                    <div class="col-12 col-sm-4 mb-3">
                        ...
                        <input type="hidden" name="hhjobid" id="hhjobid" value="<?php echo $hhjobid; ?>" />
                        ...
                        success: function(response) {
                            if (response.success) {
                                ...
                                Swal.fire({
                                    ...
                                    // Go to the next page
                                    // window.location.href = "?page=7.history_help_job";
                                });
                            } else {
                                // Show error message
                                Swal.fire({
