...
<?php 
echo "isset(_GET[perid]) = ".isset($_GET['perid'])==1;
echo "<br>";
...
<ul class="nav nav-tabs">
    ...
    <li class="nav-item">
        <a class="nav-link <?php isset($_GET['perid']) ? 'disabled' : 'disabled' ?>" href="?page=3.historyeducation&function=add&perid2=<?=$perid?>&tab=1">ช่วยเหลือด้านการศึกษา</a>
    </li>
    <li class="nav-item">
