...
<ul class="nav nav-tabs">
    ...
    <li class="nav-item">
        <a class="nav-link" href="?page=3.historyeducation&function=add&perid2=<?=$perid?>&tab=1">ช่วยเหลือด้านการศึกษา</a>
    </li>
    <li class="nav-item">
...
<div class="row justify-content-between card-header text-right mb-0">
    <div class="col-auto">
        <h4 class="app-page-title mb-0">จัดการข้อมูลบุุคคล</h4>
    </div>
    <div class="col-auto">
