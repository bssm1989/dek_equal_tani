...
$personQuery = "SELECT * FROM person where perid = $perid";
...
<ul class="nav nav-tabs">
    <li class="nav-item">
        <a class="nav-link active" aria-current="page" href="#">2.person</a>
    </li>
    <li class="nav-item">
        <a class="nav-link" href="?page=3.historyeducation&function=add&perid=<?= $perid  ?>&tab=1" >3.historyeducation</a>
    </li>
    <li class="nav-item">
