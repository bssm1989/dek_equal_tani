...
<ul class="nav nav-tabs">
    ...
    <li class="nav-item">
        ...
        <a class="nav-link <?php echo isset($_GET['perid']) == true ? ($_GET['perid'] ? '' : 'disabled') : 'disabled' ?>"" href=" ?page=4.works&function=add&perid2=<?= $perid ?>&tab=1">4.works</a>
    </li>
    <li class="nav-item">
        <!-- ?page=5.helpeducation&function=add&perid=3 -->
        <a class="nav-link <?php echo isset($_GET['perid']) == true ? ($_GET['perid'] ? '' : 'disabled') : 'disabled' ?>"" href=" ?page=5.helpeducation&function=add&perid=<?= $heduid ?>"&tab=1>5.helpeducation</a>
    </li>
    <li class="nav-item">
        <a class="nav-link <?php echo isset($_GET['perid']) == true ? ($_GET['perid'] ? '' : 'disabled') : 'disabled' ?>"" href=" ?page=6.1institute&function=add&perid=<?= $heduid ?>"&tab=1>6.1institute</a>
    </li>
    <li class="nav-item">
        <a class="nav-link <?php echo isset($_GET['perid']) == true ? ($_GET['perid'] ? '' : 'disabled') : 'disabled' ?>"" href=" ?page=7.history_help_job&function=add&perid=<?= $heduid ?>"&tab=1>7.history_help_job</a>
    </li>
    <li class="nav-item">
        <a class="nav-link <?php echo isset($_GET['perid']) == true ? ($_GET['perid'] ? '' : 'disabled') : 'disabled' ?>"" href=" ?page=8.htraining&function=add&perid=<?= $heduid ?>"&tab=1>8.htraining</a>
    </li>
    <li class="nav-item">
        <a class="nav-link <?php echo isset($_GET['perid']) == true ? ($_GET['perid'] ? '' : 'disabled') : 'disabled' ?>"" href=" ?page=9.historyeducation&function=add&perid=<?= $heduid ?>"&tab=1>9.historyeducation</a>
    </li>
...
<div class="tab-content g-4 settings-section app-card app-card-settings">

    <div class="col-12 col-md-12">
        <div class="mb-0 text-right row justify-content-between">
            <div class="col-auto">
                <h4 class="mb-0 app-page-title">จัดการข้อมูลบุคคล</h4>
            </div>
            <div class="col-auto">
        ...
        <br>
        <div class="row">
            <div class="mb-3 text-center align-middle col-md-12">
                ...
                <span style="position: relative; top: 5px;">
                    ...
                    <input type="file" name="fileupload" id="fileupload" accept="*" title="เลือกไฟล์รูปภาพ" value="" style="display: none;" onchange="PreviewImage();">

                    <div id="btn btn-primary">
                        <button id="submit" style="<?php echo ($rows['perid'] <> "" ? "display:btn btn-primary;" : "display:none;") ?>" onClick="saveFile()">บันทึก</button>
                    </div>
            ...
            <form name="frmScreening" id="frmScreening" method="post" enctype="" onSubmit="" target="">
                ...
                <div class="row">
                    <div class="col-12 col-sm-12">
                        <p class="p-2 mb-3 text-white rounded shadow-sm bg-success"> ประวัติส่วนตัว </p>
                    </div>
                </div>
                <div class="row">
                    <input type="hidden" id="perid" name="perid" value="<?= $perid; ?>">
                    <div class="mb-3 col-12 col-sm-3 md-2">
                ...
                <div class="row">
                    <div class="mb-3 col-12 col-sm-6 md-5">
                ...
                <div class="row">
                    <div class="col-12 col-sm-12">
                        <p class="p-2 mb-3 text-white rounded shadow-sm bg-success"> ที่อยู่ปัจจุบัน </p>
                    </div>
                </div>
                <div class="row">
                ...
                <div class="row">
                    <div class="col-12 col-sm-12">
                        <p class="p-2 mb-3 text-white rounded shadow-sm bg-success"> สถานภาพครอบครัว </p>
                    </div>
                </div>
                <div class="row">
                ...
                <div class="row">
                    <div class="col-12 col-sm-12">
                        <p class="p-2 mb-3 text-white rounded shadow-sm bg-success"> การเดินทางจากที่พักอาศัยไปโรงเรียน </p>
                    </div>
                </div>
                <div class="row">
                ...
                <div class="row">
                    <div class="col-12 col-sm-12">
                        <p class="p-2 mb-3 text-white rounded shadow-sm bg-success"> ความเลื่อมล้ำ </p>
                    </div>
                </div>
