...
<ul class="nav nav-tabs">
    ...
    <li class="nav-item">
        ...
        <a class="nav-link <?php echo isset($_GET['perid']) == true ? ($_GET['perid'] ? '' : 'disabled') : 'disabled' ?>"" href=" ?page=5.helpeducation&function=add&perid2=<?= $perid ?>&tab=1">5.helpeducation</a>
    </li>
    <li class="nav-item">
        <a class="nav-link <?php echo isset($_GET['perid']) == true ? ($_GET['perid'] ? '' : 'disabled') : 'disabled' ?>"" href=" ?page=6.1institute&function=add&perid2=<?= $perid ?>&tab=1">6.1institute</a>
    </li>
    <li class="nav-item">
        <a class="nav-link <?php echo isset($_GET['perid']) == true ? ($_GET['perid'] ? '' : 'disabled') : 'disabled' ?>"" href=" ?page=7.history_help_job&function=add&perid2=<?= $perid ?>&tab=1">7.history_help_job</a>
    </li>
    <li class="nav-item">
        <a class="nav-link <?php echo isset($_GET['perid']) == true ? ($_GET['perid'] ? '' : 'disabled') : 'disabled' ?>"" href=" ?page=8.htraining&function=add&perid2=<?= $perid ?>&tab=1">8.htraining</a>
    </li>
    <li class="nav-item">
        <a class="nav-link <?php echo isset($_GET['perid']) == true ? ($_GET['perid'] ? '' : 'disabled') : 'disabled' ?>"" href=" ?page=9.historyeducation&function=add&perid2=<?= $perid ?>&tab=1">9.historyeducation</a>
    </li>
