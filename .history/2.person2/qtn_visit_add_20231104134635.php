...
<?php 
echo "isset(_GET[perid]) = ".(isset($_GET['perid'])==true? '1' : '2');
echo "<br>";
echo "isset(_GET['perid2']) = ".isset($_GET['perid2']);
echo "<br>";
?>
...
<ul class="nav nav-tabs">
    ...
    <li class="nav-item">
        <a class="nav-link <?php echo isset($_GET['perid']) ==true? ($_GET['perid']?'':'disable') : '2' ?>" href="?page=3.historyeducation&function=add&perid2=<?=$perid?>&tab=1">ช่วยเหลือด้านการศึกษา</a>
    </li>
    <li class="nav-item">
