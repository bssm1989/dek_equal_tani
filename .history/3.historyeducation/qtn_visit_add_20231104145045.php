...
<?php  echo "<h1>ddffff".!($tab == 1 ||$_GET['perid']>0)."</h1>";
if (!($tab == 1 ||$_GET["perid"]>0)){ ?>
                        ...
                        success: function(response) {
                            if (response.success) {
                                ...
                                Swal.fire({
                                    ...
                                    // Go to next page
                                    window.location.href = "?page=3.historyeducation&perid=" + data['perid'];
                                });
                            } else {
                                // Show error message
                                Swal.fire({
