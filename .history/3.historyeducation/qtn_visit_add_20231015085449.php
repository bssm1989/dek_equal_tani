...
<ul class="nav nav-tabs">
  <li class="nav-item">
    <a class="nav-link "  href="#">2.person2</a>
  </li>
    <li class="nav-item">
        <a class="nav-link active" aria-current="page" href="#">3.historyeducation</a>
    </li>
    <li class="nav-item">
        <!-- ?page=3.historyeducation&function=add&perid=32 -->
        <a class="nav-link" href="?page=4.historywork&function=add&perid=<?= $heduid; ?>">4.historywork</a>
    </li>
    <li class="nav-item">
        <a class="nav-link" href="#">5.historydrug</a>
    </li>
    <li class="nav-item">
        <a class="nav-link" href="#">6.historycrime</a>
    </li>
    <li class="nav-item">
        <a class="nav-link" href="#">7.historydisease</a>
    </li>
    <li class="nav-item">
        <a class="nav-link" href="#">8.historyfamily</a>
    </li>
    <li class="nav-item">
        <a class="nav-link" href="#">9.historyeducation</a> 
    </li>
