...
<ul class="nav nav-tabs">
  <li class="nav-item">
    ...
    <li class="nav-item">
        <a class="nav-link" href="?page=7.historydisease&function=add&perid=<?= $heduid ?>">7.historydisease</a>
    </li>
    <li class="nav-item">
        <a class="nav-link" href="?page=8.historyfamily&function=add&perid=<?= $heduid ?>">8.historyfamily</a>
    </li>
    <li class="nav-item">
