                    ...
                    <div class="col-12 col-sm-4 mb-3">
                        ...
                        ?>
                            <div class="input-group custom-input-group">
                                ...
                                <button class="btn btn-outline-secondary" type="button" id="changePersonButton" disabled="">Change</button>
                            </div>
                            <label id="personSelect-error" class="error" for="personSelect">This field is required.</label>
                        ...
                        <table id="myTableAll" class="display responsive nowrap" style="width:100%">
                            ...
                            <tbody>
                                ...
                                while ($row = mysqli_fetch_assoc($results)) {
                                    ...
                                    echo '<a href="?page=' . $_GET['page'] . '&function=add&perid2=' . $row['perid'] . '&tab=1" class="btn btn-warning text-white"><i class="fas fa-edit"></i></a>';
