...
$heduid = $_GET["perid"] ? $_GET["perid"] :( $_GET["tab"]==2 ? $_GET["heduid"] : "");
                        ...
                        <table id="myTableAll" class="display responsive nowrap" style="width:100%">
                            ...
                            <tbody>
                                ...
                                while ($row = mysqli_fetch_assoc($results)) {
                                    ...
                                    echo '<a href="?page=' . $_GET['page'] . '&function=add&perid2=' . $row['perid'] . '&heduid=' . $row['heduid'] . '&tab=2" class="btn btn-warning text-white"><i class="fas fa-edit"></i></a>';
