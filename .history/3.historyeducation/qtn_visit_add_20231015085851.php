...
<ul class="nav nav-tabs">
  <li class="nav-item">
    <a class="nav-link "  href="staff.2.person2&function=add&perid=<?= $heduid ?>">2.person</a>
  </li>
    <li class="nav-item">
        <a class="nav-link active" aria-current="page" href="#">staff.3.historyeducation</a>
    </li>
    <li class="nav-item">
    ...
    <li class="nav-item">
        <a class="nav-link" href="?page=5.historydrug&function=add&perid=<?= $heduid ?>">5.historydrug</a>
    </li>
    <li class="nav-item">
        <a class="nav-link" href="?page=6.historycrime&function=add&perid=<?= $heduid ?>">6.historycrime</a>
    </li>
    <li class="nav-item">
        <a class="nav-link" href="staff.7.historydisease&function=add&perid=<?= $heduid ?>">7.historydisease</a>
    </li>
    <li class="nav-item">
        <a class="nav-link" href="staff.8.historyfamily&function=add&perid=<?= $heduid ?>">8.historyfamily</a>
    </li>
    <li class="nav-item">
        <a class="nav-link" href="staff.9.historyeducation&function=add&perid=<?= $heduid ?>">9.historyeducation</a>
    </li>
