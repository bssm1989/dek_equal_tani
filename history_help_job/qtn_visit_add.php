<?php
$hhjobid = $_GET["id"]; // Get hhjobid from page showing the list of hhelpjob
if ($hhjobid) {
...
<div class="col-12 col-sm-4 mb-3">
    ...
    <!-- You can replace this input with a radio button or dropdown menu -->
    <input type="text" class="form-control" name="hjobmoney" id="hjobmoney"
        placeholder="ลักษณะการช่วยเหลือ:: ให้เงินสด" value="<?php echo $hjobmoney; ?>" required>
</div> 
<!-- replace to dropdown
...
• รายละเอียดการช่วยเหลือ -->
                <form name="frmScreening" id="frmScreening" method="post" action="" enctype="" onSubmit="" target="">
                    ...
                    <div class="col-12 col-sm-4 mb-3">
                        <label for="perid">รหัสบุคคล</label>
                        <!-- You can replace this input with a dropdown menu populated from a query -->
                        <!-- use dropdown -->


                        <input type="text" class="form-control" name="perid" id="perid" placeholder="รหัสบุคคล" value="<?php echo $perid; ?>" required>
                    </div>
